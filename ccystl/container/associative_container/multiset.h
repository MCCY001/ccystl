#ifndef CCYSTL_MULTISET_H_
#define CCYSTL_MULTISET_H_
...
//
// 异常保证：
// ccystl::set<Key> / ccystl::multiset<Key> 满足基本异常保证，对以下等函数做强异常安全保证：
//   * emplace
//   * emplace_hint
//   * insert
...
namespace ccystl {
// 模板类 multiset，键值允许重复
// 参数一代表键值类型，参数二代表键值比较方式，缺省使用 ccystl::less
template <class Key, class Compare = ccystl::less<Key>>
class multiset {
public:
...
public:
    ...
    multiset& operator=(const multiset& rhs) = default;
