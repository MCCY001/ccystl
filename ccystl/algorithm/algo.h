#ifndef CCYSTL_ALGO_H_
#define CCYSTL_ALGO_H_
...
namespace ccystl {
    ...
    ForwardIter1
        ...
        auto d1 = ccystl::distance(first1, last1);
        auto d2 = ccystl::distance(first2, last2);
        if (d1 < d2)
            return last1;
    ...
    ForwardIter
        ...
        if (n <= 0) {
            ...
            first = ccystl::find(first, last, value);
            while (first != last) {
                auto m = n - 1;
                auto i = first;
                ++i;
                ...
                if (m == 0) {
                    ...
                    first = ccystl::find(i, last, value);
                }
            }
            return last;
        }
    ...
    ForwardIter1
        ...
        if (first2 == last2) {
            ...
            while (true) {
                ...
                auto new_result = ccystl::search(first1, last1, first2, last2);
                if (new_result == last1) {
                    return result;
                }
                else {
    ...
    BidirectionalIter1
        ...
        reviter1 rresult = ccystl::search(reviter1(last1), rlast1, reviter2(last2), rlast2);
        if (rresult == rlast1) {
            return last1;
        }
        else {
            auto result = rresult.base();
            ccystl::advance(result, -ccystl::distance(first2, last2));
            return result;
        }
    }
    ...
    ForwardIter1
        ...
        return ccystl::find_end_dispatch(first1, last1, first2, last2, Category1(), Category2());
    }
    ...
    ForwardIter1
        ...
        if (first2 == last2) {
            ...
            while (true) {
                // 利用 search 查找某个子序列的首次出现点，找不到则返回 last1
                auto new_result = ccystl::search(first1, last1, first2, last2, comp);
                if (new_result == last1) {
                    return result;
                }
                else {
    ...
    BidirectionalIter1
        ...
        reviter1 rlast1(first1);
        reviter2 rlast2(first2);
        reviter1 rresult = ccystl::search(reviter1(last1), rlast1, reviter2(last2), rlast2, comp);
        if (rresult == rlast1) {
            return last1;
        }
        else {
    ...
    ForwardIter1
        ...
        typedef typename iterator_traits<ForwardIter1>::iterator_category Category1;
        typedef typename iterator_traits<ForwardIter2>::iterator_category Category2;
        return ccystl::find_end_dispatch(first1, last1, first2, last2, Category1(), Category2(), comp);
    }
    ...
    ForwardIter
        ...
        auto len = ccystl::distance(first, last);
        auto half = len;
        ForwardIter middle;
        while (len > 0) {
            half = len >> 1;
            middle = first;
            ccystl::advance(middle, half);
            if (*middle < value) {
                first = middle;
                ++first;
                len = len - half - 1;
    ...
    ForwardIter
        ...
        return ccystl::lbound_dispatch(first, last, value, iterator_category(first));
    }
    ...
    ForwardIter
        ...
        return ccystl::lbound_dispatch(first, last, value, iterator_category(first), comp);
    }
    ...
    ForwardIter
        ...
        return ccystl::ubound_dispatch(first, last, value, iterator_category(first));
    }
    ...
    ForwardIter
        ...
        return ccystl::ubound_dispatch(first, last, value, iterator_category(first), comp);
    }
    ...
    bool binary_search(ForwardIter first, ForwardIter last, const T& value) {
        auto i = ccystl::lower_bound(first, last, value);
    ...
    template <class ForwardIter, class T>
    ccystl::pair<ForwardIter, ForwardIter>
        ...
        while (len > 0) {
            ...
            if (*middle < value) {
                ...
                left = ccystl::lower_bound(first, last, value);
                ccystl::advance(first, len);
                right = ccystl::upper_bound(++middle, first, value);
                return ccystl::pair<ForwardIter, ForwardIter>(left, right);
            }
        }
        return ccystl::pair<ForwardIter, ForwardIter>(last, last);
    }

    // erange_dispatch 的 random_access_iterator_tag 版本
    template <class RandomIter, class T>
    ccystl::pair<RandomIter, RandomIter>
        ...
        while (len > 0) {
            ...
            if (*middle < value) {
                ...
                left = ccystl::lower_bound(first, middle, value);
                right = ccystl::upper_bound(++middle, first + len, value);
                return ccystl::pair<RandomIter, RandomIter>(left, right);
            }
        }
        return ccystl::pair<RandomIter, RandomIter>(last, last);
    }

    template <class ForwardIter, class T>
    ccystl::pair<ForwardIter, ForwardIter>
        equal_range(ForwardIter first, ForwardIter last, const T& value) {
        return ccystl::erange_dispatch(first, last, value, iterator_category(first));
    }
    ...
    ccystl::pair<ForwardIter, ForwardIter>
        ...
        while (len > 0) {
            ...
            if (comp(*middle, value)) {
                ...
                left = ccystl::lower_bound(first, last, value, comp);
                ccystl::advance(first, len);
                right = ccystl::upper_bound(++middle, first, value, comp);
                return ccystl::pair<ForwardIter, ForwardIter>(left, right);
            }
        }
        return ccystl::pair<ForwardIter, ForwardIter>(last, last);
    ...
    ccystl::pair<RandomIter, RandomIter>
        ...
        while (len > 0) {
            ...
            if (comp(*middle, value)) {
                ...
                left = ccystl::lower_bound(first, middle, value, comp);
                right = ccystl::upper_bound(++middle, first + len, value, comp);
                return ccystl::pair<RandomIter, RandomIter>(left, right);
            }
        }
        return ccystl::pair<RandomIter, RandomIter>(last, last);
    ...
    ccystl::pair<ForwardIter, ForwardIter>
        ...
        return ccystl::erange_dispatch(first, last, value, iterator_category(first), comp);
    }
    ...
    bool is_heap(RandomIter first, RandomIter last) {
        auto n = ccystl::distance(first, last);
        auto parent = 0;
    ...
    ForwardIter2
        ...
        for (; first1 != last1; ++first1, ++first2) {
            ccystl::iter_swap(first1, first2);
        }
        return first2;
    }
    ...
    ForwardIter remove(ForwardIter first, ForwardIter last, const T& value) {
        first = ccystl::find(first, last, value);  // 利用 find 找出第一个匹配的地方
        auto next = first;
        return first == last ? first : ccystl::remove_copy(++next, last, first, value);
    }
    ...
    ForwardIter
        ...
        first = ccystl::find_if(first, last, unary_pred);  // 利用 find_if 找出第一个匹配的地方
        auto next = first;
        return first == last ? first : ccystl::remove_copy_if(++next, last, first, unary_pred);
    }
    ...
    void reverse(BidirectionalIter first, BidirectionalIter last) {
        ccystl::reverse_dispatch(first, last, iterator_category(first));
    }
    ...
    void random_shuffle(RandomIter first, RandomIter last) {
        ...
        for (auto i = first + 1; i != last; ++i) {
            ccystl::iter_swap(i, first + (rand() % (i - first + 1)));
        }
    }
    ...
    void random_shuffle(RandomIter first, RandomIter last,
        ...
        auto len = ccystl::distance(first, last);
        for (auto i = first + 1; i != last; ++i) {
            ccystl::iter_swap(i, first + (rand(i - first + 1) % len));
        }
    }
    ...
    BidirectionalIter
        ...
        ccystl::reverse_dispatch(first, middle, bidirectional_iterator_tag());
        ccystl::reverse_dispatch(middle, last, bidirectional_iterator_tag());
        while (first != middle && middle != last)
            ccystl::swap(*first++, *--last);
        if (first == middle) {
            ccystl::reverse_dispatch(middle, last, bidirectional_iterator_tag());
            return last;
        }
    ...
    RandomIter
        ...
        if (l == r) {
            ccystl::swap_ranges(first, middle, middle);
            return result;
        }
    ...
    ForwardIter
        ...
        if (middle == last)
            return first;
        return ccystl::rotate_dispatch(first, middle, last, iterator_category(first));
    }
    ...
    ForwardIter
        ...
        return ccystl::copy(first, middle, ccystl::copy(middle, last, result));
    }
    ...
    bool is_permutation_aux(ForwardIter1 first1, ForwardIter1 last1,
        ForwardIter2 first2, ForwardIter2 last2,
        BinaryPred pred) {
        constexpr bool is_ra_it = ccystl::is_random_access_iterator<ForwardIter1>::value
            && ccystl::is_random_access_iterator<ForwardIter2>::value;
        if (is_ra_it) {
        ...
        if (is_ra_it) {
            ...
            auto len1 = ccystl::distance(first1, last1);
            auto len2 = ccystl::distance(first2, last2);
            if (len1 == 0 && len2 == 0)
                return true;
            if (len1 != len2)
                return false;
    ...
    bool is_permutation(ForwardIter1 first1, ForwardIter1 last1,
        ...
        static_assert(std::is_same<v1, v2>::value,
            "the type should be same in ccystl::is_permutation");
    ...
    bool next_permutation(BidirectionalIter first, BidirectionalIter last) {
        ...
        for (;;) {
            ...
            if (*--i < *ii) {                 // 找到第一对小于关系的元素
                auto j = last;
                while (!(*i < *--j)) {}
                ccystl::iter_swap(i, j);       // 交换 i，j 所指元素
                ccystl::reverse(ii, last);     // 将 ii 之后的所有元素反转
                return true;
            }
            if (i == first) {
                ccystl::reverse(first, last);
                return false;
            }
        }
    }
    ...
    void merge_without_buffer(BidirectionalIter first, BidirectionalIter middle,
        ...
        if (len1 > len2) {  // 序列一较长，找到序列一的中点
            len11 = len1 >> 1;
            ccystl::advance(first_cut, len11);
            second_cut = ccystl::lower_bound(middle, last, *first_cut);
            len22 = ccystl::distance(middle, second_cut);
        }
        else {              // 序列二较长，找到序列二的中点
            len22 = len2 >> 1;
            ccystl::advance(second_cut, len22);
            first_cut = ccystl::upper_bound(first, middle, *second_cut);
            len11 = ccystl::distance(first, first_cut);
        }
        auto new_middle = ccystl::rotate(first_cut, middle, second_cut);
        ccystl::merge_without_buffer(first, first_cut, new_middle, len11, len22);
        ccystl::merge_without_buffer(new_middle, second_cut, last, len1 - len11, len2 - len22);
    }
    ...
    BidirectionalIter1
        ...
        if (first1 == last1)
            return ccystl::copy_backward(first2, last2, result);
        if (first2 == last2)
            return ccystl::copy_backward(first1, last1, result);
        --last1;
        --last2;
        while (true) {
            if (*last2 < *last1) {
    ...
    BidirectionalIter1
        ...
        if (len1 > len2 && len2 <= buffer_size) {
            buffer_end = ccystl::copy(middle, last, buffer);
            ccystl::copy_backward(first, middle, last);
            return ccystl::copy(buffer, buffer_end, first);
        }
        else if (len1 <= buffer_size) {
            buffer_end = ccystl::copy(first, middle, buffer);
            ccystl::copy(middle, last, first);
            return ccystl::copy_backward(buffer, buffer_end, last);
        }
        else {
            return ccystl::rotate(first, middle, last);
        }
    }
    ...
    void merge_adaptive(BidirectionalIter first, BidirectionalIter middle,
        ...
        if (len1 <= len2 && len1 <= buffer_size) {
            Pointer buffer_end = ccystl::copy(first, middle, buffer);
            ccystl::merge(buffer, buffer_end, middle, last, first);
        }
        else if (len2 <= buffer_size) {
            Pointer buffer_end = ccystl::copy(middle, last, buffer);
            ccystl::merge_backward(first, middle, buffer, buffer_end, last);
        }
        else {  // 区间长度太长，分割递归处理
            auto first_cut = first;
            auto second_cut = middle;
            ...
            auto new_middle = ccystl::rotate_adaptive(first_cut, middle, second_cut,
                len1 - len11, len22, buffer, buffer_size);
            ccystl::merge_adaptive(first, first_cut, new_middle, len11, len22, buffer, buffer_size);
            ccystl::merge_adaptive(new_middle, second_cut, last, len1 - len11,
    ...
    void
        ...
        auto len1 = ccystl::distance(first, middle);
        auto len2 = ccystl::distance(middle, last);
        temporary_buffer<BidirectionalIter, T> buf(first, last);
        if (!buf.begin()) {
            ccystl::merge_without_buffer(first, middle, last, len1, len2);
        }
        else {
            ccystl::merge_adaptive(first, middle, last, len1, len2, buf.begin(), buf.size());
        }
    }
    ...
    void
        ...
        if (first == middle || middle == last)
            return;
        ccystl::inplace_merge_aux(first, middle, last, value_type(first));
    }
    ...
    void merge_without_buffer(BidirectionalIter first, BidirectionalIter middle,
        ...
        if (len1 > len2) {
            len11 = len1 >> 1;
            ccystl::advance(first_cut, len11);
            second_cut = ccystl::lower_bound(middle, last, *first_cut, comp);
            len22 = ccystl::distance(middle, second_cut);
        }
        else {
            len22 = len2 >> 1;
            ccystl::advance(second_cut, len22);
            first_cut = ccystl::upper_bound(first, middle, *second_cut, comp);
            len11 = ccystl::distance(first, first_cut);
        }
        auto new_middle = ccystl::rotate(first_cut, middle, second_cut);
        ccystl::merge_without_buffer(first, first_cut, new_middle, len11, len22, comp);
        ccystl::merge_without_buffer(new_middle, second_cut, last, len1 - len11, len2 - len22, comp);
    }
    ...
    void merge_adaptive(BidirectionalIter first, BidirectionalIter middle,
        ...
        if (len1 <= len2 && len1 <= buffer_size) {
            Pointer buffer_end = ccystl::copy(first, middle, buffer);
            ccystl::merge(buffer, buffer_end, middle, last, first, comp);
        }
        else if (len2 <= buffer_size) {
            Pointer buffer_end = ccystl::copy(middle, last, buffer);
            ccystl::merge_backward(first, middle, buffer, buffer_end, last, comp);
        }
        else {  // 区间长度太长，分割递归处理
            auto first_cut = first;
            auto second_cut = middle;
            ...
            auto new_middle = ccystl::rotate_adaptive(first_cut, middle, second_cut, len1 - len11,
                len22, buffer, buffer_size);
            ccystl::merge_adaptive(first, first_cut, new_middle, len11,
    ...
    void
        ...
        temporary_buffer<BidirectionalIter, T> buf(first, last);
        if (!buf.begin()) {
            ccystl::merge_without_buffer(first, middle, last, len1, len2, comp);
        }
        else {
            ccystl::merge_adaptive(first, middle, last, len1, len2, buf.begin(), buf.size(), comp);
        }
    }
    ...
    void
        ...
        if (first == middle || middle == last)
            return;
        ccystl::inplace_merge_aux(first, middle, last, value_type(first), comp);
    }
    ...
    void partial_sort(RandomIter first, RandomIter middle,
        RandomIter last) {
        ccystl::make_heap(first, middle);
        for (auto i = middle; i < last; ++i) {
            if (*i < *first) {
                ccystl::pop_heap_aux(first, middle, i, *i, distance_type(first));
            }
        }
        ccystl::sort_heap(first, middle);
    }
    ...
    void partial_sort(RandomIter first, RandomIter middle,
        ...
        ccystl::make_heap(first, middle, comp);
        for (auto i = middle; i < last; ++i) {
            if (comp(*i, *first)) {
                ccystl::pop_heap_aux(first, middle, i, *i, distance_type(first), comp);
            }
        }
        ccystl::sort_heap(first, middle, comp);
    }
    ...
    RandomIter
        ...
        ccystl::make_heap(result_first, result_iter);
        while (first != last) {
            if (*first < *result_first) {
                ccystl::adjust_heap(result_first, static_cast<Distance>(0),
                    result_iter - result_first, *first);
            }
            ++first;
        }
        ccystl::sort_heap(result_first, result_iter);
        return result_iter;
    }
    ...
    RandomIter
        partial_sort_copy(InputIter first, InputIter last,
            RandomIter result_first, RandomIter result_last) {
        return ccystl::psort_copy_aux(first, last, result_first, result_last,
    ...
    RandomIter
        ...
        ccystl::make_heap(result_first, result_iter, comp);
        while (first != last) {
        ...
        ccystl::sort_heap(result_first, result_iter, comp);
        return result_iter;
    }
    ...
    // 其余放到 result_false 的输出区间，并返回一个 ccystl::pair 指向这两个区间的尾部
    /*****************************************************************************************/
    template <class InputIter, class OutputIter1, class OutputIter2, class UnaryPredicate>
    ccystl::pair<OutputIter1, OutputIter2>
        ...
        return ccystl::pair<OutputIter1, OutputIter2>(result_true, result_false);
    }
    ...
    void intro_sort(RandomIter first, RandomIter last, Size depth_limit) {
        while (static_cast<size_t>(last - first) > kSmallSectionSize) {
            if (depth_limit == 0) {                      // 到达最大分割深度限制
                ccystl::partial_sort(first, last, last);  // 改用 heap_sort
                return;
            }
            --depth_limit;
            auto mid = ccystl::median(*(first), *(first + (last - first) / 2), *(last - 1));
            auto cut = ccystl::unchecked_partition(first, last, mid);
            ccystl::intro_sort(cut, last, depth_limit);
            last = cut;
        }
    }
    ...
    void unchecked_insertion_sort(RandomIter first, RandomIter last) {
        for (auto i = first; i != last; ++i) {
            ccystl::unchecked_linear_insert(i, *i);
        }
    }
    ...
    void insertion_sort(RandomIter first, RandomIter last) {
        ...
        for (auto i = first + 1; i != last; ++i) {
            auto value = *i;
            if (value < *first) {
                ccystl::copy_backward(first, i, i + 1);
                *first = value;
            }
            else {
                ccystl::unchecked_linear_insert(i, value);
            }
        }
    }
    ...
    void final_insertion_sort(RandomIter first, RandomIter last) {
        if (static_cast<size_t>(last - first) > kSmallSectionSize) {
            ccystl::insertion_sort(first, first + kSmallSectionSize);
            ccystl::unchecked_insertion_sort(first + kSmallSectionSize, last);
        }
        else {
            ccystl::insertion_sort(first, last);
        }
    }
    ...
    void sort(RandomIter first, RandomIter last) {
        if (first != last) {
            ...
            ccystl::intro_sort(first, last, slg2(last - first) * 2);
            ccystl::final_insertion_sort(first, last);
        }
    }
    ...
    void intro_sort(RandomIter first, RandomIter last,
        ...
        while (static_cast<size_t>(last - first) > kSmallSectionSize) {
            if (depth_limit == 0) {                            // 到达最大分割深度限制
                ccystl::partial_sort(first, last, last, comp);  // 改用 heap_sort
                return;
            }
            --depth_limit;
            auto mid = ccystl::median(*(first), *(first + (last - first) / 2), *(last - 1));
            auto cut = ccystl::unchecked_partition(first, last, mid, comp);
            ccystl::intro_sort(cut, last, depth_limit, comp);
            last = cut;
        }
    }
    ...
    void unchecked_insertion_sort(RandomIter first, RandomIter last,
        Compared comp) {
        for (auto i = first; i != last; ++i) {
            ccystl::unchecked_linear_insert(i, *i, comp);
        }
    }
        ...
        for (auto i = first + 1; i != last; ++i) {
            ...
            if (comp(value, *first)) {
                ...
                *first = value;
                ...
                ccystl::unchecked_linear_insert(i, value, comp);
            }
        }
    }
    ...
    void final_insertion_sort(RandomIter first, RandomIter last, Compared comp) {
        if (static_cast<size_t>(last - first) > kSmallSectionSize) {
            ccystl::insertion_sort(first, first + kSmallSectionSize, comp);
            ccystl::unchecked_insertion_sort(first + kSmallSectionSize, last, comp);
        }
        else {
            ccystl::insertion_sort(first, last, comp);
        }
    }
    ...
    void sort(RandomIter first, RandomIter last, Compared comp) {
        if (first != last) {
            // 内省式排序，将区间分为一个个小区间，然后对整体进行插入排序
            ccystl::intro_sort(first, last, slg2(last - first) * 2, comp);
            ccystl::final_insertion_sort(first, last, comp);
        }
    }
    ...
    void nth_element(RandomIter first, RandomIter nth,
        ...
        if (nth == last)
            return;
        while (last - first > 3) {
            auto cut = ccystl::unchecked_partition(first, last, ccystl::median(*first,
                *(first + (last - first) / 2),
                *(last - 1)));
    ...
    OutputIter
        ...
        if (first == last)
            return result;
        return ccystl::unique_copy_dispatch(first, last, result, iterator_category(result));
    }
    ...
    OutputIter
        ...
        if (first == last)
            return result;
        return ccystl::unique_copy_dispatch(first, last, result, iterator_category(result), comp);
    }
    ...
    ForwardIter unique(ForwardIter first, ForwardIter last) {
        first = ccystl::adjacent_find(first, last);
        return ccystl::unique_copy(first, last, first);
    }

    // 重载版本使用函数对象 comp 代替比较操作
    template <class ForwardIter, class Compared>
    ForwardIter unique(ForwardIter first, ForwardIter last, Compared comp) {
        first = ccystl::adjacent_find(first, last, comp);
        return ccystl::unique_copy(first, last, first, comp);
    }
