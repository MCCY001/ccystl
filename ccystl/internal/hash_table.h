...
namespace ccystl {
    ...
    struct hashtable_node {
        ...
        hashtable_node(hashtable_node&& node) :next(node.next), value(ccystl::move(node.value)) {
            node.next = nullptr;
        }
    };
    ...
    struct ht_value_traits {
        static constexpr bool is_map = ccystl::is_pair<T>::value;
    ...
    struct ht_iterator_base :public ccystl::iterator<ccystl::forward_iterator_tag, T> {
        typedef ccystl::hashtable<T, Hash, KeyEqual>         hashtable;
...
// 4. end with p = prev_prime(2 << 31 - 1)
    ...
    public:
        ...
        typedef ccystl::allocator<node_type>                 node_allocator;
    ...
    public:
        ...
        template <class Iter, typename std::enable_if<
            ccystl::is_input_iterator<Iter>::value, int>::type = 0>
    ...
    void hashtable<T, Hash, KeyEqual>::
        ...
        data_allocator::destroy(ccystl::address_of(node->value));
